...
public class MethodTypePoolEntry extends ClassConstantPoolEntry<Integer> {
     ...
     */
    public MethodTypePoolEntry(byte[] rawData) {
        super(rawData);
    }
    ...
    public Integer getParsedData() {
        return Byte.toUnsignedInt(this.getData()[1]);
    }
}